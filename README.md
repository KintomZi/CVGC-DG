...
The official implementation for [Cross-view Domain Generalization via Geometric Consistency for LiDAR Semantic Segmentation](http://arxiv.org/abs/2602.14525)
...
@misc{zhao2026crossview,
      ...
      archivePrefix={arXiv},
      primaryClass={cs.CV},
      url={https://arxiv.org/abs/2602.14525}, 
}
```

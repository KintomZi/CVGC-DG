# @Link : https://github.com/gzgzys9887/DGLSS/blob/fc046f27e82e030481de7c1170a28d489e8c8df1/models/minkunet.py
...
class MinkUNetBase(ResNetBase):
    ...
    def forward(self, x, layers: list = None):
        ...
        return self.final(out), out, out_tuple
...
class MinkUNetBase_IS(ResNetBase):
    BLOCK = None
    PLANES = None
    ...
    def forward(self, x, is_seg=True):
        ...
        if is_seg:
            return self.final(out), out_bottle
        else:
            return out, out_bottle


class MinkUNet18IS(MinkUNetBase_IS):
    BLOCK = BasicBlock
    LAYERS = (2, 2, 2, 2, 2, 2, 2, 2)
